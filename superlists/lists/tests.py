...
class ListViewTest(TestCase):
    ...
    def test_displays_items_for_list(self):
        ...
        list_wrong = List.objects.create()
        Item.objects.create(text='itemey 3', list = list_wrong)
        Item.objects.create(text='itemey 4', list = list_wrong)
        ...
        self.assertNotContains(response, 'itemey 3') #3
        self.assertNotContains(response, 'itemey 4') #3
